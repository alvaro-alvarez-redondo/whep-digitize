...
def get_postpro_audit_paths(config: Config) -> PostproAuditPaths:
    ...
    Returns:
        The resolved :class:`PostproAuditPaths` (no directories are created).
...
def initialize_postpro_audit_root(config: Config) -> PostproAuditPaths:
    ...
    Returns:
        The created :class:`PostproAuditPaths`.
    """
